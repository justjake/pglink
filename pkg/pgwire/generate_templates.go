...
// pgwire: -from=Client -type=Startup -method=ParseFrontend:pgproto3.FrontendMessage:m.Parse() -method=Source:RawMessageSource:m.source -method=IsParsed:bool:m.isParsed -method=ParseAny:pgproto3.Message:m.Parse()
...
// pgwire: -from=Client -type=SimpleQuery -method=ParseFrontend:pgproto3.FrontendMessage:m.Parse() -method=Source:RawMessageSource:m.source -method=IsParsed:bool:m.isParsed -method=ParseAny:pgproto3.Message:m.Parse()
...
// pgwire: -from=Client -type=ExtendedQuery -method=ParseFrontend:pgproto3.FrontendMessage:m.Parse() -method=Source:RawMessageSource:m.source -method=IsParsed:bool:m.isParsed -method=ParseAny:pgproto3.Message:m.Parse()
...
// pgwire: -from=Client -type=Copy -method=ParseFrontend:pgproto3.FrontendMessage:m.Parse() -method=Source:RawMessageSource:m.source -method=IsParsed:bool:m.isParsed -method=ParseAny:pgproto3.Message:m.Parse()
...
// pgwire: -from=Client -type=Cancel -method=ParseFrontend:pgproto3.FrontendMessage:m.Parse() -method=Source:RawMessageSource:m.source -method=IsParsed:bool:m.isParsed -method=ParseAny:pgproto3.Message:m.Parse()
...
// pgwire: -from=Client -type=TerminateConn -method=ParseFrontend:pgproto3.FrontendMessage:m.Parse() -method=Source:RawMessageSource:m.source -method=IsParsed:bool:m.isParsed -method=ParseAny:pgproto3.Message:m.Parse()
...
// pgwire: -from=Server -type=Startup -method=ParseBackend:pgproto3.BackendMessage:m.Parse() -method=Source:RawMessageSource:m.source -method=IsParsed:bool:m.isParsed -method=ParseAny:pgproto3.Message:m.Parse()
...
// pgwire: -from=Server -type=ExtendedQuery -method=ParseBackend:pgproto3.BackendMessage:m.Parse() -method=Source:RawMessageSource:m.source -method=IsParsed:bool:m.isParsed -method=ParseAny:pgproto3.Message:m.Parse()
...
// pgwire: -from=Server -type=Copy -method=ParseBackend:pgproto3.BackendMessage:m.Parse() -method=Source:RawMessageSource:m.source -method=IsParsed:bool:m.isParsed -method=ParseAny:pgproto3.Message:m.Parse()
...
//
// pgwire: -from=Server -type=Response -method=ParseBackend:pgproto3.BackendMessage:m.Parse() -method=Source:RawMessageSource:m.source -method=IsParsed:bool:m.isParsed -method=ParseAny:pgproto3.Message:m.Parse()
...
// pgwire: -from=Server -type=Async -method=ParseBackend:pgproto3.BackendMessage:m.Parse() -method=Source:RawMessageSource:m.source -method=IsParsed:bool:m.isParsed -method=ParseAny:pgproto3.Message:m.Parse()
