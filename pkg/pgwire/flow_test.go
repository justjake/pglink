...
func TestSimpleQueryFlow_BasicFlow(t *testing.T) {
	...
	flow := NewSimpleQueryFlow(
		(*ClientQuery)(ClientParsed(&pgproto3.Query{String: "SELECT 1"})),
	...
	if !handlers.Update((*ServerDataRow)(ServerParsed(&pgproto3.DataRow{Values: [][]byte{[]byte("1")}}))) {
	...
	// More data rows
	handlers.Update((*ServerDataRow)(ServerParsed(&pgproto3.DataRow{Values: [][]byte{[]byte("2")}})))
	if flow.RowCount != 2 {
		t.Errorf("RowCount = %d, want 2", flow.RowCount)
	}

	// CommandComplete
	if !handlers.Update((*ServerCommandComplete)(ServerParsed(&pgproto3.CommandComplete{CommandTag: []byte("SELECT 2")}))) {
	...
	if handlers.Update((*ServerReadyForQuery)(ServerParsed(&pgproto3.ReadyForQuery{TxStatus: 'I'}))) {
...
func TestSimpleQueryFlow_WithError(t *testing.T) {
	flow := NewSimpleQueryFlow(
		(*ClientQuery)(ClientParsed(&pgproto3.Query{String: "INVALID SQL"})),
		nil,
	)
	...
	// ErrorResponse
	if !handlers.Update((*ServerErrorResponse)(ServerParsed(&pgproto3.ErrorResponse{
		Severity: "ERROR",
		Code:     "42601",
...
func TestExtendedQueryFlow_ParseDescribeSync(t *testing.T) {
	...
	flow := NewExtendedQueryFlow(
		(*ClientParse)(ClientParsed(&pgproto3.Parse{Name: "stmt1", Query: "SELECT $1"})),
	...
	// ParseComplete
	handlers.Update((*ServerParseComplete)(ServerParsed(&pgproto3.ParseComplete{})))

	// ParameterDescription
	handlers.Update((*ServerParameterDescription)(ServerParsed(&pgproto3.ParameterDescription{})))

	// RowDescription
	handlers.Update((*ServerRowDescription)(ServerParsed(&pgproto3.RowDescription{})))
...
func TestExtendedQueryFlow_ParseBindExecuteSync(t *testing.T) {
	flow := NewExtendedQueryFlow(
		(*ClientParse)(ClientParsed(&pgproto3.Parse{Name: "", Query: "SELECT $1"})),
		nil,
	)
	...
	// Client: Bind
	handlers.Update((*ClientBind)(ClientParsed(&pgproto3.Bind{
	...
	// Client: Execute
	handlers.Update((*ClientExecute)(ClientParsed(&pgproto3.Execute{Portal: "p1"})))
	...
	handlers.Update((*ServerParseComplete)(ServerParsed(&pgproto3.ParseComplete{})))
	handlers.Update((*ServerBindComplete)(ServerParsed(&pgproto3.BindComplete{})))
	handlers.Update((*ServerDataRow)(ServerParsed(&pgproto3.DataRow{Values: [][]byte{[]byte("42")}})))
	if flow.RowCount != 1 {
		t.Errorf("RowCount = %d, want 1", flow.RowCount)
	}
	handlers.Update((*ServerCommandComplete)(ServerParsed(&pgproto3.CommandComplete{CommandTag: []byte("SELECT 1")})))
...
func TestExtendedQueryFlow_WithError(t *testing.T) {
	flow := NewExtendedQueryFlow(
		(*ClientParse)(ClientParsed(&pgproto3.Parse{Name: "", Query: "INVALID"})),
		nil,
	)
	...
	handlers.Update((*ServerErrorResponse)(ServerParsed(&pgproto3.ErrorResponse{
		Severity: "ERROR",
		Code:     "42601",
		Message:  "syntax error",
	})))
...
func TestCopyFlow_CopyIn(t *testing.T) {
	...
	handlers.Update((*ClientCopyData)(ClientParsed(&pgproto3.CopyData{Data: []byte("line1\n")})))
	if flow.ByteCount != 6 {
		t.Errorf("ByteCount = %d, want 6", flow.ByteCount)
	}

	handlers.Update((*ClientCopyData)(ClientParsed(&pgproto3.CopyData{Data: []byte("line2\n")})))
	if flow.ByteCount != 12 {
		t.Errorf("ByteCount = %d, want 12", flow.ByteCount)
	}

	// Server: CommandComplete
	handlers.Update((*ServerCommandComplete)(ServerParsed(&pgproto3.CommandComplete{CommandTag: []byte("COPY 2")})))
...
func TestCopyFlow_CopyOut(t *testing.T) {
	...
	handlers.Update((*ServerCopyData)(ServerParsed(&pgproto3.CopyData{Data: []byte("row1\n")})))
	if flow.ByteCount != 5 {
		t.Errorf("ByteCount = %d, want 5", flow.ByteCount)
	}

	handlers.Update((*ServerCopyData)(ServerParsed(&pgproto3.CopyData{Data: []byte("row2\n")})))
...
func TestSimpleQueryRecognizer(t *testing.T) {
	...
	recognizer := &SimpleQueryRecognizer{
		OnStart: func(msg *ClientQuery) func(*SimpleQueryFlow) {
	...
	flow := handlers.Start((*ClientQuery)(ClientParsed(&pgproto3.Query{String: "SELECT 1"})))
	if flow == nil {
	...
	flow = handlers.Start((*ClientParse)(ClientParsed(&pgproto3.Parse{Query: "SELECT $1"})))
	if flow != nil {
...
func TestExtendedQueryRecognizer(t *testing.T) {
	...
	recognizer := &ExtendedQueryRecognizer{
		OnStart: func(msg *ClientParse) func(*ExtendedQueryFlow) {
	...
	flow := handlers.Start((*ClientParse)(ClientParsed(&pgproto3.Parse{Name: "stmt1", Query: "SELECT $1"})))
	if flow == nil {
	...
	flow = handlers.Start((*ClientBind)(ClientParsed(&pgproto3.Bind{})))
	if flow != nil {
...
func TestCopyRecognizer(t *testing.T) {
	...
	flow := handlers.Start((*ServerCopyInResponse)(ServerParsed(&pgproto3.CopyInResponse{})))
	if flow == nil {
	...
	flow = handlers.Start((*ServerCopyOutResponse)(ServerParsed(&pgproto3.CopyOutResponse{})))
	if flow == nil {
	...
	flow = handlers.Start((*ServerCopyData)(ServerParsed(&pgproto3.CopyData{})))
	if flow != nil {
...
func TestProtocolState_FlowTracking(t *testing.T) {
	...
	queryMsg := (*ClientQuery)(ClientParsed(&pgproto3.Query{String: "SELECT 1"}))
	...
	state.ProcessFlows((*ServerDataRow)(ServerParsed(&pgproto3.DataRow{})))
	state.ProcessFlows((*ServerCommandComplete)(ServerParsed(&pgproto3.CommandComplete{CommandTag: []byte("SELECT 1")})))
	...
	state.ProcessFlows((*ServerReadyForQuery)(ServerParsed(&pgproto3.ReadyForQuery{TxStatus: 'I'})))
...
func TestProtocolState_MultipleFlows(t *testing.T) {
	...
	state.ProcessFlows((*ClientQuery)(ClientParsed(&pgproto3.Query{String: "SELECT 1"})))
	...
	state.ProcessFlows((*ClientParse)(ClientParsed(&pgproto3.Parse{Name: "stmt1", Query: "SELECT $1"})))
	...
	state.ProcessFlows((*ServerParseComplete)(ServerParsed(&pgproto3.ParseComplete{})))
	state.ProcessFlows((*ServerReadyForQuery)(ServerParsed(&pgproto3.ReadyForQuery{TxStatus: 'I'})))
